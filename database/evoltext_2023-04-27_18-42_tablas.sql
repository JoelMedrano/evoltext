...
CREATE TABLE `companies` (
  ...
  `state_company` int(11) DEFAULT NULL,
  `level_company` int(11) DEFAULT NULL,
...
insert  into `companies`(`id_company`,`code_company`,`dis_company`,`document_company`,`name_company`,`tradename_company`,`address_company`,`postal_company`,`email_company`,`phone1_company`,`phone2_company`,`state_company`,`level_company`,`date_created_company`,`date_updated_company`) values (1,'00001','6','10472810371','JOEL VLADIMIR MEDRANO GÜERE','Control Devs',NULL,NULL,NULL,NULL,NULL,1,1,NULL,'2023-04-27 12:22:22');
...
insert  into `correlatives`(`id_correlative`,`code_correlative`,`name_correlative`,`initial_correlative`,`actual_correlative`,`final_correlative`) values (1,'admins','admins',0,21,NULL);
...
insert  into `users`(`id_user`,`code_user`,`username_user`,`dis_user`,`document_user`,`name_user`,`address_user`,`postal_user`,`phone1_user`,`phone2_user`,`email_user`,`password_user`,`token_user`,`token_exp_user`,`rol_user`,`picture_user`,`method_user`,`state_user`,`last_login_user`,`id_company_user`,`pcreg_user`,`usreg_user`,`pcmod_user`,`usmod_user`,`date_created_user`,`date_updated_user`) values (5,'00001','jvmedranog','1','47281037','Joel Medrano Güere',NULL,NULL,NULL,NULL,'jvmedranog@gmail.com','$2a$07$azybxcags23425sdg23sdeanQZqjaf6Birm2NvcYTNtJw24CsO5uq','eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE2ODI2MzA4NTUsImV4cCI6MTY4MjcxNzI1NSwiZGF0YSI6eyJpZCI6IjUiLCJlbWFpbCI6Imp2bWVkcmFub2dAZ21haWwuY29tIn19.3C1laqXXECyJVUNQFVrABRTJq3nmCL-T1OJG--MuRPo','1682717255','1',NULL,'direct',46,NULL,1,NULL,NULL,NULL,NULL,'2023-04-22','2023-04-27 16:27:35'),(12,'00016','mgjv','6','10472810371','Medrano G?Ere Joel Vladimir','CAL. GREGORIO SISA NRO. 133 URB. TUNGASUCA 2DA. ETAPA LIMA - LIMA - CARABAYLLO','150106','982009013','','mgjv@gmail.com','$2a$07$azybxcags23425sdg23sdev4tYhTqNI8D5Sbrs98GU8.MXkadNXB2','eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE2ODI2MzA4NDgsImV4cCI6MTY4MjcxNzI0OCwiZGF0YSI6eyJpZCI6IjEyIiwiZW1haWwiOiJtZ2p2QGdtYWlsLmNvbSJ9fQ.HdV5I3erdrYfo-LqNKgHYCuTObjf6Uy3m-EoddKIOzc','1682717248','3','12.png','direct',11,NULL,1,'SISTEMAS-3','jvmedranog',NULL,NULL,'2023-04-25','2023-04-27 16:27:28'),(14,'00017','ttcunzac','1','47490910','Cunza Castillo Tiffany Thalia','JR. LOS TULIPANES PISO 2 ASENT.H. LOS OLIVOS MZ. I LT. 5','150117','','','cunza.dg@gmail.com','$2a$07$azybxcags23425sdg23sdeovSQG5ZNz1uRkXYzn4F5RaghgIkTmgG',NULL,NULL,'2','14.jpg','direct',46,NULL,1,'SISTEMAS-3','jvmedranog',NULL,NULL,'2023-04-25','2023-04-27 16:22:32');
