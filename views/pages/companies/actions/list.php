...
<div class="card">
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            <div class="pd-10 flex-grow-1">
                <a class="btn btn-dark btn-sm" href="/companies/new" onclick="createCorrelativo('companies')">New Company</a>
            </div>
            <div class="pd-10">
    ...
    <!-- /.card-header -->
    <div class="card-body">
        <table id="adminsTable" class="table table-bordered table-striped tableCompanies">
            <thead>
                <tr>
                    <th>#</th>
                    <th>Foto</th>
