    ...
    <div class="main-container container-fluid">
        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="left-content">
                <span class="main-content-title mg-b-0 mg-b-lg-1">Empresas</span>
            </div>
                ...
                <ol class="breadcrumb">
                    ...
                    if (isset($routesArray[2])) {
                        ...
                        if ($routesArray[2] == "new" || $routesArray[2] == "edit") {
                            ...
                            echo '<li class="breadcrumb-item"><a href="/companies">Empresas</a></li>';
                            echo '<li class="breadcrumb-item active">' . $routesArray[2] . '</li>';
                        }
                    } else {

                        echo '<li class="breadcrumb-item active">Empresas</li>';
                    }
